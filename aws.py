...
returns: True on success and False on failure
"""
def sns_publish(topic_arn, message, subject):
...
""" subscribe_to_sns_topic() sunscribes a lambda function to a sns topic. Give
SNS the ability to invoke the lambda function.
...
def subscribe_to_sns_topic(topic_name, lambda_arn):
    # give sns permision to invoke lambda function
